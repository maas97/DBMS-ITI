#!/bin/bash
# A simple DBMS using Bash Shell scripting by Ahmed Ramadan & Mohamed Ashraf
mkdir DBMS 2>> ./.error.log
clear
echo "Welcome To DBMS - This is made by ITI Students: Ahmed Ramadan & Mohamed Ashraf"
